...
final User currentUser = User(
  ...
  'https://drive.google.com/uc?export=view&id=1Am1pY7vhi1y9rjQrLc5qyzDNMBXb1ldC',
);
...
final List<Post> posts = [
  Post(
    user: currentUser,
    caption: 'Boshonto Boron 2023',
    timeAgo: '58m',
    imageUrl: 'https://drive.google.com/uc?export=view&id=1XJws6uPlt0vTB4lWDNsQi8tEjS1ewpGb',
    likes: 1202,
    comments: 184,
    shares: 96,
  ),
